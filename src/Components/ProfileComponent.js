...
import SidePanel from "../Components/ProfilePage/Profile_SidePanel_component.js";
import SidePanelTabbed from "../Components/ProfilePage/Profile_SidePanelTabbed_component.js";
    ...
    <div className="stats_tabs_container">
      ...
      {activeTabIndex == 0 && (
        <div className={`profile_component ${isBothVisible ? "" : ""} `}>
          ...
          >
            <SidePanel playerData={playerData} playerTabs={playerTabs} />
